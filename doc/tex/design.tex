...
\begin{tabular}{|p{\textwidth}|}
	\hline
	Algorithm: \\
       	Calculating the acceleration of the planet towards its parent body \\
	\hline 
	Description: \\
	This algorithm takes the position of the body in question, its mass and
	the mass and position of the parent body. It then calculates the body's
	acceleration towards its parent, which can be used to calculate its new
	position. \\
	\hline
	Pseudocode: \\
	\begin{equation}
