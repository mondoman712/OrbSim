...
\begin{tabular}{|p{0.5\textwidth}|p(0,5\textwidth|}
	\hline
	\multicolumn{2}{|p{\textwidth}|}{Algorithm:} \\
	\multicolumn{2}{|p{\textwidth}|}{Calculating the acceleration of the
		planet towards its parent body}\\
	\hline 
	\multicolumn{2}{|p{\textwidth}|}{Description:} \\
	\multicolumn{2}{|p{\textwidth}|}{This algorithm takes the position of
		the body in question, its mass and the mass and position of the
		parent body.  It then calculates the body's acceleration towards
		its parent, which can be used to calculate its new position.} \\
	\hline
	\multicolumn{2}{|p{\textwidth}|}{Pseudocode:} \\
	\multicolumn{2}{|p{\textwidth}|}{\begin{equation}
	g = \frac{GM}{r^2}
	\end{equation}} \\ \hline
	\multicolumn{2}{|p{\textwidth}|}{Code:} \\
	\begin{lstlisting}
	(defvar *G* 6.67e-11)
	(defun calc-g (M r)
	  (/ (* *G* M) (* r r)))
	...
	Inputs & Outputs \\
	$M = 5.97 \times 10^{24}$ (The mass of Earth) \\
